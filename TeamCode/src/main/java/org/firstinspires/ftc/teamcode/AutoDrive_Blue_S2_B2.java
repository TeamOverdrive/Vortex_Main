...
@Autonomous(name="AutoDrive: Inside 2 Beacon (Blue)", group="Vortex")
//@Disabled //Disable program to drop from phone list
public class AutoDrive_BLUE_S2_B2 extends AutoSuper {
    @Override
    public void runOpMode() {
        ...
        turn180L();
        encoderDrive(DRIVE_SPEED * 0.5, 15.0, 15.0, 3.0);
        turnGyroAbs(180);
